...
| 5   | [Legal Discovery / Subpoena Response](legal-discovery.md)        | Court-admissible production of user content for litigation or regulatory request. | `ediscovery`                                                              | End-to-end (preservation → collection → review → production) via eDiscovery v3. |
